...
public class Manager : MonoBehaviour
{
    ...
    [SerializeField] GameObject[] playerPositions;
    ...
    [SerializeField] Gradient[] trailColors;

    private DoorButton[] doorBtn;
    ...
    void Start()
    {
        ...
        doorBtn = FindObjectsOfType<DoorButton>();
    ...
    void Restart()
    {
        ...
        foreach (DoorButton btn in doorBtn)
        {
            btn.Reset();
        }
    ...
    private void SelectCharacter()
    {
        if (PlayerPrefs.HasKey("equip"))
        {
            ...
            {
                player.GetComponent<SpriteRenderer>().sprite = playerSprites[PlayerPrefs.GetInt("equip")];
               
                player.GetComponent<TrailRenderer>().colorGradient = trailColors[PlayerPrefs.GetInt("equip")];
                //player.GetComponentInChildren<TrailRenderer>().colorGradient = trailColors[PlayerPrefs.GetInt("equip")];
            ...
            else
            {
                ...
                player.GetComponent<TrailRenderer>().colorGradient = trailColors[0];
                //player.GetComponentInChildren<TrailRenderer>().colorGradient = trailColors[PlayerPrefs.GetInt("equip")];
            }
        }
        else
